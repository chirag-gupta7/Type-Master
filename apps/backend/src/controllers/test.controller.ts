...
export const getUserStats = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    // and fetch only the most recent tests in parallel. This avoids loading large datasets
    // into memory and prevents potential stack overflow issues from Math.max(...).
