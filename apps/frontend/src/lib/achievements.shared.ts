 ...
 * Mirrored from packages/shared/src/achievements.ts for frontend consumption.
 * Keep in sync – update packages/shared/src/achievements.ts and copy here (or use @typemaster/shared alias).
 */
