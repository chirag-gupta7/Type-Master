...
export function SkillTreeVisualization({ data }: SkillTreeVisualizationProps) {
  ...
  // PERFORMANCE OPTIMIZATION: Memoize lessonsByLevel and sorted levels to prevent
  // expensive array traversal, grouping, and sorting operations on high-frequency
  // hover (hoveredNode) and select (selectedNode) state changes.
